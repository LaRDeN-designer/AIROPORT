...
namespace AIROPORT.Migrations
{
    ...
    partial class AIROPORTContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BD_AIROPORT.Models.Routes", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BD_AIROPORT.Models.Tickets", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("CostTiket")
                        .HasColumnType("int");

                    b.Property<string>("NamePassenger")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PassportDataPassengers")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BD_AIROPORT.Models.Crews", b =>
                {
                    b.HasOne("BD_AIROPORT.Models.Routes", null)
                        .WithMany("Crew")
            ...
            modelBuilder.Entity("BD_AIROPORT.Models.Routes", b =>
                {
                    b.HasOne("BD_AIROPORT.Models.Tickets", null)
                        .WithMany("Route")
